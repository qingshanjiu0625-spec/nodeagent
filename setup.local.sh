...
# 2) 基础变量（可通过环境变量覆盖）
############################################
CONTAINER_NAME="${CONTAINER_NAME:-nodeagent4}"
#IMAGE_DEFAULT="${IMAGE_DEFAULT:-docker.io/qingshanjiu/nodeagent:latest}"
IMAGE_DEFAULT="${IMAGE_DEFAULT:-openclaw4}"


DATA_ROOT="${DATA_ROOT:-${HOME}/.nodeagent4}"     # 宿主机持久化根目录
...
DEFAULT_PORT="${DEFAULT_PORT:-62434}"
